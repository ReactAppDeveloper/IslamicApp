...
app.use("/api/duabycategory", require("./routes/duabycategory.routes"));
...
app.use("/api/duaversebycategory", require("./routes/duaversebycategory.routes"));
app.use("/api/duacategories", require("./routes/duacategories.routes"));
app.use("/api/duacategoriesbyid", require("./routes/duacategoriesbyid.routes"));
...
app.use("/api/wallofrememberbyid", require("./routes/wallofrememberbyid.routes"));
